        ...
        <div class="container-fluid">
            ...
            <div class="row explore-content-row">
                <div class="col-1 col-lg-2 p-0">
                    <div class="explore-more-swiper-button-prev swiper-button-prev"  role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-424f98f7acf7bfdd" aria-disabled="true"></div>
                </div>
                <div class="col-10 col-lg-8 p-0 explore-content-col">
                    <div class="swiper-container explore-more-slider-container swiper-container-initialized swiper-container-horizontal">
                        <div class="swiper-wrapper explore-more-slider-wrapper" id="swiper-wrapper-424f98f7acf7bfdd" aria-live="polite">
                            ...
                            <div class="swiper-slide" data-index="<?php echo $i;?>" style="margin-right: 15px;" role="group" aria-label="1 / 5">
                ...
                <div class="col-1 col-lg-2 p-0">
                    <div class="explore-more-swiper-button-next swiper-button-next" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-424f98f7acf7bfdd" aria-disabled="false"></div>
                </div>
            </div>
        </div>
    </section>
